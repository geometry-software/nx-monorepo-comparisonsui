...
export const accountEnglishMessages = {
  ...
  "account.verifiedDescription":
    "Request session token via WebSocket",
  ...
  "account.updateSession": "Update Session",
  ...
  "account.sessionUpdated": "Session updated",
  ...
  "account.updateError": "Unable to update the session.",
...
> = {
  ...
  es: {
    ...
    "account.verifiedDescription":
      "Solicitar token de sesión mediante WebSocket",
    ...
    "account.updateSession": "Actualizar sesión",
    ...
    "account.sessionUpdated": "Sesión actualizada",
    "account.updateError": "No se pudo actualizar la sesión.",
  ...
  pt: {
    ...
    "account.verifiedDescription":
      "Solicitar token de sessão via WebSocket",
    "account.verify": "Verificar",
    "account.verifyDescription":
    ...
    "account.updateSession": "Atualizar sessão",
    ...
    "account.sessionUpdated": "Sessão atualizada",
    "account.updateError": "Não foi possível atualizar a sessão.",
