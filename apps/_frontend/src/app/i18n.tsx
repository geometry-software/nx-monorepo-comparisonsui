...
const englishMessages = {
  ...
  'header.requestInProgress': '{{method}} database request in progress: {{duration}} ms',
  'header.requestCompleted': '{{method}} database request completed in {{duration}} ms',
  ...
  'info.swaggerDescription': 'Interactive API documentation for Year, TGI, and Comparisons.',
  ...
  'installation.stepStartAllText': 'From the repository root, run npm start to launch the frontend and three APIs.',
  'designSystem.eyebrow': 'Interface foundation',
  'designSystem.title': 'Design System',
  'designSystem.subtitle': 'Reusable application components shared by the correlation interface.',
  'designSystem.appGroup': 'Application components',
  'designSystem.appGroupText': 'Interact with each component to inspect its states and behavior.',
  'designSystem.componentsCount': '{{count}} components',
  'app.loading': 'Loading…',
} as const;
